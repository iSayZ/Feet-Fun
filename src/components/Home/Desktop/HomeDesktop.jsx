        ...
        <div className="figures-container">
          <div className="pokemon-figure figure-new">
            ...
            <div className="img-poke-container-home-desktop">
              <img
                src="../assets/images/bulbi.jpeg"
                className="img-sock-home"
                alt=""
              />
              <img
                src="../assets/images/pika.jpeg"
                className="img-sock-home"
                alt=""
              />
              <img
                src="../assets/images/pokemonbannière.webp"
          ...
          <div className="art-figure figure-new">
            ...
            <div className="img-art-container-home-desktop">
              <img
                src="../assets/images/mondrian2.jpg"
                className="img-sock-home"
                alt=""
              />
              <img
                src="../assets/images/pollock1.jpeg"
                className="img-sock-home"
                alt=""
              />
              <img
                src="../assets/images/art-contempo.jpg"
                className="img-illu-home"
                alt=""
              />
            </div>

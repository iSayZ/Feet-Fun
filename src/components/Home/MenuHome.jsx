          ...
          <div className="fondMenuHome-inner">
            <div className="fondMenuHome-front">
              <img
                ...
                src="../assets/images/ArtCarré.jpg"
                alt="imageArt"
              />
            </div>
        ...
        <div className="fondMenuHome">
          <div className="fondMenuHome-inner">
            <div className="fondMenuHome-front">
              <img
                className="carréImageMenu"
                src="../assets/images/SportCarré.png"
                alt="imagesport"
              />
            </div>
            <div className="fondMenuHome-back">
        ...
        <div className="fondMenuHome">
          <div className="fondMenuHome-inner">
            <div className="fondMenuHome-front">
              <img
                className="carréImageMenu"
                src="../assets/images/GeekCarré.jpg"
                alt="imagegeek"
              />
            </div>
        ...
        <div className="fondMenuHome">
          <div className="fondMenuHome-inner">
            <div className="fondMenuHome-front">
              <img
                className="carréImageMenu"
                src="../assets/images/AnimeCarré.avif"
                alt="imageAnimé"
              />
            </div>
            <div className="fondMenuHome-back">
        ...
        <div className="fondMenuHome">
          <div className="fondMenuHome-inner">
            <div className="fondMenuHome-front">
              <img
                className="carréImageMenu"
                src="../assets/images/FestifCarré.jpg"
                alt="imageFestif"
              />
            </div>
            <div className="fondMenuHome-back">

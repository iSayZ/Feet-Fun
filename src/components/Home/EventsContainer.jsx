  ...
  const dataAccueil = [
    {
      ...
      img1: "../assets/images/bulbi.jpeg",
      img2: "../assets/images/pokemonbannière.webp",
      img3: "../assets/images/pika.jpeg",
      link: "/filtre?query=productsFilterNew-2"
    },
    {
      id: 1,
      title: "Collection 'Art contemporain'",
      img1: "../assets/images/mondrian2.jpg",
      img2: "../assets/images/artcontempo.jpg",
      img3: "../assets/images/pollock1.jpeg",

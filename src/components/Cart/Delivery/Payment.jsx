          ...
          <div className="creditCards">
            ...
            >
              <img
                ...
                src="../assets/images/fakecards/fakecard1.svg"
                alt="CB 1"
              />
            </button>
            <button
            ...
            >
              <img
                className="fakeCardsImg"
                src="../assets/images/fakecards/fakecard2.svg"
                alt="CB 2"
              />
            </button>
            <button
            ...
            >
              <img
                className="fakeCardsImg"
                src="../assets/images/fakecards/fakecard3.svg"
                alt="CB 3"
              />
            </button>
            <button
            ...
            >
              <img
                className="fakeCardsImg"
                src="../assets/images/fakecards/fakecard4.svg"
                alt="CB 4"
              />
            </button>
          </div>
